...
class AmplitudeModulation:
    ...
    @channel.setter
    def channel(self, value):
        """Setter for the channel attributes"""
        self._channel = value
...
class Measurement:
    ...
    def __init__(self):
        # in seconds (s) Time to wait for stabilization of the output
        # channel before starting the input channel
        self.stabilization_time = 0
        self.buffer_time = 0.5
        self.t_pre_signal = (
            None  # The time before the signal is send to the output channel
        )
...
class Run:
    ...
    def __init__(self):
        self.resolution = 1  # Number of
        self.time_between_mnt = 1
        self.mnt_repeats = 5
        self.label = "give_me_a_label"  # Label of measurement run
        self.data_dir = None
        self.result_dir = None
        self.analysis_dir = None
        self.label = None
