...
@dataclass
class OutputChannel:
    """Standard configuration of the parameters defining the morphology 
    of the signal through the output channel for the AD2"""
    def __init__(self):
        self.channel: int = 1 #
...
class Measurement:
    ...
    def __init__(self):
        ...
        self.t_pre_signal = None #The delay between data acquisition and the sending of the pulse
        ...
        self.bit_mask_s2 = int(0b00000011) # Not currently used
        self.data_dir = None
        self.result_dir = None
        self.analysis_dir = None 
        self.label = None #Label of measurement run. Is set during the run

@dataclass
class Run:
    '''Stand configuration of the run'''
    def __init__(self):
        self.resolution = 5 #Number of different frequencies to measure
        self.time_between_mnt = 1
        self.mnt_repeats = 5
        self.label = 'null' #Label of measurement run
        self.data_dir = None
        self.result_dir = None
        self.analysis_dir = None
...
class Parameters:
    ...
    def __init__(self):
        self.experiment = 'free_spin_decay'
        self.pulse = PiPulse()
